...
- **问题驱动**：从当前瓶颈/失败/成本/用户摩擦出发找外部替代；
- **前沿驱动**：从新能力出发，再映射本项目是否真有对应问题；
- **反证驱动**：主动找现有关键假设的失败案例和更优基线。

不能长期只跑同一组关键词。后来证明重要但雷达没发现的候选，要做 missed-signal 复盘，并更新来源/查询策略。
...
- **stop_rule**：什么证据、成本或风险会停止实验、降回 WATCH 或 RETIRE。
