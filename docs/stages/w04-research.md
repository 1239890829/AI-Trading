...
- **证据**：现有 theme-sentiment、theme-prediction、hunting-decision、KB37项及 strategy-registry 已含梯队、角色、消息、弱市穿越、结构转换和失败样本的碎片知识。2026-09-26 Phase 0 在只读 marketdb 上实跑：探索段 676.6 万条日线分母、29.2 万条名义涨幅代理事件与同日分桶对照，2024 验证段／2025 起保留段未查询结果；实际统计、SHA、字段缺口与历史接口探针见[研究蓝图 §14](../research/limit-up-dragon-research.md#14-phase-0-首轮实测与停止点2026-09-26)。这不是正式全量涨停／炸板宇宙、点时证据或效果通过。
- **下一步**：已发现本机历史题材成员、新闻首次可见时点、ST／上市豁免身份不足；2020-08-24 同花顺涨停池可查而炸板池报业务码 1002，东财同日炸板空池不能充当完整负样本。先取得有授权、全期覆盖、可追踪修订及明确费用／许可的历史正式涨停／炸板、题材成员和可见语料，核逐日分页与点时身份，再生成正式 event universe、匹配对照和 evidence bundle。未满足前停止扩大实验、不揭开保留段；正式特征／战法增益仍按 RSH-026／IMP-020，Jev 语义效果仍须 RSH-030 独立人工 anchor。
