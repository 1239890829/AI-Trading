...
- **下一步**：Phase 0 先冻结历史覆盖、板块制度、涨停/炸板定义、历史题材成员、新闻/公告/涨停原因可见时点、竞价/人气/资金/分钟覆盖、污染案例和最近保留段；随后从较早一批历史事件生成 event universe + matched controls + evidence bundle，只做 atlas/质量审计，再选少量候选进入预注册实验。Jev 小样本先走 RSH-030 的人工 anchor/独立 prediction，不批量烧调用。
