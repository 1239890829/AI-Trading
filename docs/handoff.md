...
- GX 治理只可作为不冲突的伴随切片；2026-09-20 新增 W08/GOV-026 工作区卫生与资产生命周期治理，源于本轮发现的临时 clone/pytest 沙箱/artifacts 长期堆积。它**不改变 G0 主门或 BUG-028 首选**，只能在不冲突时作为伴随切片实施，不能以“清理磁盘”为由跨过业务阻断门。
