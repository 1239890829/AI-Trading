...
cd backend && .venv/bin/pytest --basetemp=/tmp/pytest-basetemp     # 后端 2625 项（2563 passed / 62 skipped）· 171 文件（09-12 实测）
...
> **门禁口径**：后端 2625 项（2563 passed / 62 skipped）· 171 文件、前端 429 项 / 52 文件、eslint **0 error / 0 warn**
