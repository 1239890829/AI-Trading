...
cd backend && .venv/bin/pytest --basetemp=/tmp/pytest-basetemp     # 后端 2482 项（2421 passed / 61 skipped）· 163 文件（09-11 实测）
...
> **门禁口径**：后端 2482 项（2421 passed / 61 skipped）· 163 文件、前端 380 项 / 50 文件、eslint **0 error / 0 warn**
