...
cd backend && .venv/bin/pytest --basetemp=/tmp/pytest-basetemp     # 后端 2760 项（2698 passed / 62 skipped）· 180 文件（09-13 §6.23 实测）
...
> **门禁口径**：后端 2760 项（2698 passed / 62 skipped）· 180 文件、前端 456 项 / 54 文件、eslint **0 error / 0 warn**
