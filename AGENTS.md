...
cd backend && .venv/bin/pytest --basetemp=/tmp/pytest-basetemp     # 后端 2537 项（2476 passed / 61 skipped）· 167 文件（09-11 实测）
...
> **门禁口径**：后端 2537 项（2476 passed / 61 skipped）· 167 文件、前端 392 项 / 51 文件、eslint **0 error / 0 warn**
