...
cd backend && .venv/bin/pytest --basetemp=/tmp/pytest-basetemp     # 后端 2291 项（2230 passed / 61 skipped）· 156 文件（09-11 实测）
...
> **门禁口径**：后端 2291 项（2230 passed / 61 skipped）· 156 文件、前端 380 项 / 50 文件、eslint **0 error / 0 warn**
