...
cd backend && .venv/bin/pytest --basetemp=/tmp/pytest-basetemp     # 后端 2575 项（2514 passed / 61 skipped）· 168 文件（09-12 实测）
...
> **门禁口径**：后端 2575 项（2514 passed / 61 skipped）· 168 文件、前端 415 项 / 51 文件、eslint **0 error / 0 warn**
