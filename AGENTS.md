...
cd backend && .venv/bin/pytest --basetemp=/tmp/pytest-basetemp     # 后端 2695 项（2633 passed / 62 skipped）· 173 文件（09-12 实测）
...
> **门禁口径**：后端 2695 项（2633 passed / 62 skipped）· 173 文件、前端 454 项 / 54 文件、eslint **0 error / 0 warn**
...
> 2584 / 2585 / 2590 / 2602 / 2606 / 2619 / 2620 / 2632 / 2635 / 2674 / 2691 / 前端 423 / 429 / 444」均已被后续改动追过，教训见 `docs/retro-and-gaps.md` §七）。
