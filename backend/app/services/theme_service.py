...
已知边界（不可臆造）
--------------------
- 板块的 3/5/10 日涨跌幅为东财字段序推断，**未经 K 线交叉验证**，响应中标注 `verified: false`。
...
THEME_ALIASES: dict[str, str] = {
    # 业绩驱动：半年报/中报/三季报的增长类表述本质是同一驱动（财报），
    # 拆开会人为制造碎片题材（实测 8/28 前三大标签全是业绩类，合计 27 只）。
    "业绩增长": "业绩驱动",
    "业绩预增": "业绩驱动",
    "业绩改善": "业绩驱动",
    "中报增长": "业绩驱动",
    ...
    "半年报减亏": "业绩驱动",
    "业绩扭亏": "业绩驱动",
    # 业绩类补充（实测 8/28 出现，若不合并会散成「业绩高增长」「净利增长」等伪题材）
    "业绩高增长": "业绩驱动",
    "业绩大增": "业绩驱动",
    "净利增长": "业绩驱动",
    "净利润增长": "业绩驱动",
    ...
    "国企改革": "国资改革",
    "央企改革": "国资改革",
    # 算力链内部同义（8/28 实测散出「算力服务」「AI液冷」「数据中心业务」等碎片）
    "液冷服务器": "液冷",
    "AI液冷": "液冷",
    "算力": "算力",
    "算力服务": "算力",
    ...
    "数据中心业务": "数据中心",
    "数据中心交换机": "数据中心",
    # 机器人：人形机器人是机器人的细分，炒作时视为同一梯队
    "人形机器人": "机器人",
    # 化工材料同义
    "PTFE薄膜": "PTFE",
    # 转基因：与种业同源，避免「转基因玉米」单成一档
    "转基因玉米": "转基因",
    # 控制权 / 重组
    "控制权拟变更": "控制权变更",
    "控制权转让": "控制权变更",
