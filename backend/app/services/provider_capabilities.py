...
CAPABILITIES: dict[str, dict[str, dict]] = {
    "ths": {
        ...
        "get_raw_daily_kline": _s("prices-historical adjust=none；仅供结果标签价格基准锚定"),
    ...
    "eastmoney": {
        ...
        "get_raw_daily_kline": _s("push2his klt=101/fqt=0 不复权日K；结果标签 raw anchor 备源"),
    ...
    "sina": {
        ...
        "get_raw_daily_kline": _n("无不复权历史日K实现"),
        "get_order_book": _s("五档盘口备源"),
        "get_trades": _t("恒空占位"),
