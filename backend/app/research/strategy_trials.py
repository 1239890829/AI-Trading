...
Offline research evidence only. This module seals the complete attempt denominator
and exact symbol-by-date overlap; it never promotes a strategy.
"""
...
def trial_family_evidence(
    ...
    """Record every attempted rule and apply the registered family correction."""
    a = _finite(alpha)
...
def overlap_evidence_from_counts(
    *, target_label: str, target_condition: str, target_n: int,
    ...
    """Seal already-computed exact symbol-by-date overlap counts."""
...
def signal_overlap_evidence(
    ...
    """Compute exact symbol-by-date overlap against named incumbent signals."""
